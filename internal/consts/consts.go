...
const (
	...
	CurdLoginUserLock        string = "用户锁定"
	CurdLoginUserErr         string = "无效用户"
	CurdLoginPasswdErr       string = "密码错误"
	CurdLoginUserOrPasswdErr string = "用户名或密码错误"
	CurdOperateFailMsg       string = "前后端时间不同步，请配置前后端时间"
